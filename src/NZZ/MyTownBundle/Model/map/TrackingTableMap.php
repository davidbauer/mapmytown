...
/**
 * This class defines the structure of the 'tracking' table.
 *
 *
 *
 ...
 */
class TrackingTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'src.NZZ.MyTownBundle.Model.map.TrackingTableMap';
    ...
    {
        // attributes
        $this->setName('tracking');
        $this->setPhpName('Tracking');
        $this->setClassname('NZZ\\MyTownBundle\\Model\\Tracking');
